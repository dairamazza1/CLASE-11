...
app.set('view engine', 'hbs'); //se define extension (motor de plantilla)
...
app.get('/productos', function (req, res) {
    ...
    const prod = newContenedor.getAll().then( (obj) =>{
    obj.length  > 0 ?  res.render('form', {listExists: true, listProduct: obj }) : res.render('form', {listNotExists: true}) ;   
    })  
